...
// Event listener para los formularios de búsqueda
...
function mostrarAutos(autos) {
    ...
    autos.forEach( auto => {
        ...
        autoHTML.textContent = `
            ${auto.marca} ${auto.modelo} - ${year} - ${puertas} Puertas - Transmisión: ${transmision} -
...
function noResultado() {
    ...
    noResultado.textContent = 'No hay resultados, intenta otras opciones';
